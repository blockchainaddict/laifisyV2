  ...
  return (
    <div className="home-wrapper">
      ...
      <div className="info-wrapper">
        <ul>
          <li>➜ <b>Create</b> your content for all social networks with ease, all in the same place</li>
          <li>➜ <b>Organize</b> your created content to keep track of all your work</li>
          <li>➜ Get the <b>help of AI</b> to create content if you're on a rush or having writer's block</li>
          <li className="li-with-popup">➜ <b>Share</b> your work to your clients/co-workers or anyone, in 
            <span 
              onMouseEnter={() => setIsHovering(true)} 
              onMouseLeave={() => setIsHovering(false)} 
              className="simple-steps"> <u>3 simple steps</u>
            </span>
            {isHovering && (
              <div className="home-popup">
                <p>1. Create content</p>
                <p>2. Choose a method (Create <i>Share link</i> or <i>Download PDF)</i></p>
                <p>3. Share via Email, Whatsapp or directly on our Platform</p>
              </div>)}
          </li>
          <li>➜ Get <b>Insights</b> through our Analytics system, knowing what you've created and posted so far</li>
          <li>➜ Make your life <b>easy</b>!</li>
        </ul>
      </div>
